      ...
      <div className="post_detail">
        <div className="post_box">
          ...
          <div className="post_text">
            ...
            obcaecati quaerat recusandae alias aspernatur debitis illum animi
            explicabo? In voluptate molestias eos neque nulla asperiores
            distinctio delectus! Minus, illum asperiores.
          </div>
        </div>
      </div>
    </>
